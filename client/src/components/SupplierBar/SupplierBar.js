...
function SupplierBar({active1="", active2="",active3="", active4="", active5=""}) {
  return (
    <div className='app__SupplierPage_options'>
      <ul>
        ...
        <Link to='/supplier/sell'><li><span className={'option ' + active3 + ' app__text_effect'}>Encomendas</span></li></Link>
        <Link to='/supplier/produnit'><li><span className={'option ' + active4 + ' app__text_effect'}>Unidade Produção</span></li></Link>
        <Link to='/supplier/encomendas'><li><span className={'option ' + active5 + ' app__text_effect'}>Histórico</span></li></Link>
      </ul>
    </div>
  )
}
