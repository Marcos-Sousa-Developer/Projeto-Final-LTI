...
$\textcolor{red}{\text{INFO: este comando não é obrigatório, porque o comando anterior verifica as dependências no ficheiro package.json, caso tenha algum erro, é importante executá-lo!}}$.
```bash
npm i nodemon -D
```   
