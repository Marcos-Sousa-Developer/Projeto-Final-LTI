...
No **2ºpasso** e **3ºpasso** apresentá-se duas formas diferentes de rodar o código e poder interagir com o sistema. <br>
O **2ºpasso** é a convenção, ou melhor dizendo a abordagem normal, com comandos executados através do terminal e com chamadas ao **npm** e **npx**. 
O **3ºpasso** e último consiste no uso do Docker de modo a automatizar a implementação da aplicação (ou de conjuntos de processos que constituem uma app) dentro de um ambiente de container, ou seja automatiza o **2ºpasso**. 
